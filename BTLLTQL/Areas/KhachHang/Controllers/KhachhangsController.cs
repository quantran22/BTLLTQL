...
namespace BTLLTQL.Areas.KhachHang.Controllers
{
    ...
    public class KhachhangsController : Controller
    {
        ...
        // GET: KhachHang/Khachhangs
        public ActionResult Index()
        {
            return View(db.Khachhangs.ToList());
        }

        // GET: KhachHang/Khachhangs/Details/5
        ...
        // GET: KhachHang/Khachhangs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: KhachHang/Khachhangs/Create
        ...
        // GET: KhachHang/Khachhangs/Edit/5
        ...
        // POST: KhachHang/Khachhangs/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: KhachHang/Khachhangs/Delete/5
        ...
        // POST: KhachHang/Khachhangs/Delete/5
